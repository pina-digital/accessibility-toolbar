...
;var f=t("html"),w=(t("body"),t(".open-accessibility")),x=t(".open-accessibility-menu"),z=t(".open-accessibility-expand-button"),k=t(".open-accessibility-close-button"),B=t(".open-accessibility-invert-button"),C=t(".open-accessibility-cursor-button"),I=t(".open-accessibility-font-zoom-in-button"),E=t(".open-accessibility-font-zoom-out-button"),M=t(".open-accessibility-page-zoom-button"),L=t(".open-accessibility-monochrome-button"),A=t(".open-accessibility-contrast-button"),S=t(".open-accessibility-links-button"),Z=t(".open-accessibility-animation-button"),O=t(".open-accessibility-imgRemove-button"),V=t(".open-accessibility-focus-button"),H=t(".open-accessibility-fontReadable-button"),D=t(".open-accessibility-headings-button"),P=t(".open-accessibility-reset-button"),G=t(".open-accessibility-cursor-workaround"),F=t("#lang-sel"),T=t("#togBtn"),R=t("#pZoom-indicator"),_=t("#fZoomIn-indicator"),j=t("#fZoomOut-indicator");a(y.fontSelector,1),w.addClass(d(y.iconSize));var N=c(y.localization,y.localizationMap);l(N[Object.keys(N)[0]]),f.addClass("open-accessibility-font-Zoom"),t(".open-accessibility-expand-button,.open-accessibility-close-button,.open-accessibility-menu-button, .l-switch, .open-accessibility-language-selector, .open-accessibility-menu-footer").keyup(function(n){13!=n.keyCode&&32!=n.keyCode||(n.preventDefault(),t(this).click())});var q;t(window).on("load resize",function(){q=this.screen.height,u()}),t("#accDec").attr("href",y.accessibilityDeclaration),z.click(function(){y.isMenuOpened=!0,u()}),k.click(function(){y.isMenuOpened=!1,u()}),t(document).click(function(n){t(n.target).closest(".open-accessibility").length||y.isMenuOpened&&(y.isMenuOpened=!1,u())}),z.hide(),x.hide(),n.isMenuOpened?(y.isMenuOpened=!0,x.show(),z.hide()):y.isMenuOpened=!1,document.getElementById("togBtn").checked=y.toolbarSide,T.change(function(){y.toolbarSide=!y.toolbarSide,u()}),F.change(function(){y.localization=t(this).val();var n=y.localization;"he"==n?(y.localization=["he"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])):"en"==n?(y.localization=["en"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])):"ru"==n?(y.localization=["ru"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])):"ar"==n?(y.localization=["ar"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])):"es"==n?(y.localization=["es"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])):"fr"==n&&(y.localization=["fr"],N=c(y.localization,y.localizationMap),l(N[Object.keys(N)[0]])),y.isMenuOpened=!0,u()}),I.click(function(){y.fZoom=Math.min(y.maxFZoomLevel,y.fZoom+y.fZoomStep),u(),_.addClass("button-indicator"),_.removeClass("hidden-indicator"),setTimeout(r,2e3)}),E.click(function(){y.fZoom=Math.max(y.minFZoomLevel,y.fZoom-y.fZoomStep),u(),j.addClass("button-indicator"),j.removeClass("hidden-indicator"),setTimeout(p,2e3)}),C.click(function(){y.cursor=!y.cursor,u()}),M.click(function(){1==y.pZoom&&(y.origMenuTop=document.getElementById("pina-main").offsetTop),y.pZoom+=y.pZoomStep;var t=1/y.pZoom;y.mZoom=t,y.pZoom>y.maxPZoomLevel&&(y.pZoom=y.minPZoomLevel,y.mZoom=y.minPZoomLevel),u(),R.addClass("button-indicator"),R.removeClass("hidden-indicator"),setTimeout(m,2e3)}),G.hide(),e()||t(document).on("mousemove",function(t){y.cursor&&G.css({left:t.pageX/y.fZoom,top:t.pageY/y.fZoom})}),A.click(function(){y.contrast+=50,y.contrast>150&&(y.contrast=50),u()}),B.click(function(){y.invert=!y.invert,u()}),L.click(function(){y.grayscale+=100,y.grayscale>100&&(y.grayscale=0),u()}),S.click(function(){y.highlightedLinks=!y.highlightedLinks,u()}),Z.click(function(){y.isAnimStopped=!y.isAnimStopped,u()}),O.click(function(){y.imagesRemove=!y.imagesRemove,u()}),V.click(function(){y.focus=!y.focus,u()}),H.click(function(){y.fontReadable=!y.fontReadable,u()}),D.click(function(){y.headings=!y.headings,u()}),P.click(function(){var n=o();y=t.extend({},h),y.localization=n.localization,y.toolbarSide=n.toolbarSide,u()}),u()}}(jQuery||$);