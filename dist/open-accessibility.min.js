...
;var w=t("html"),x=(t("body"),t(".open-accessibility")),z=t(".open-accessibility-menu"),C=t(".open-accessibility-expand-button"),k=t(".open-accessibility-close-button"),B=t(".open-accessibility-invert-button"),I=t(".open-accessibility-cursor-button"),E=t(".open-accessibility-font-zoom-in-button"),M=t(".open-accessibility-font-zoom-out-button"),A=t(".open-accessibility-page-zoom-button"),L=t(".open-accessibility-monochrome-button"),S=t(".open-accessibility-contrast-button"),O=t(".open-accessibility-links-button"),Z=t(".open-accessibility-animation-button"),V=t(".open-accessibility-imgRemove-button"),H=t(".open-accessibility-focus-button"),P=t(".open-accessibility-fontReadable-button"),D=t(".open-accessibility-headings-button"),G=t(".open-accessibility-revert-button"),F=t(".open-accessibility-cursor-workaround"),_=t("#lang-sel"),R=t("#togBtn"),T=t("#pZoom-indicator"),j=t("#fZoomIn-indicator"),N=t("#fZoomOut-indicator");a(f.fontSelector,1),x.addClass(r(f.iconSize)),document.documentElement.style.setProperty("--main-color",f.mainColor);var q=c(f.localization,f.localizationMap);l(q[Object.keys(q)[0]]),w.addClass("open-accessibility-font-Zoom"),t(".open-accessibility-expand-button,.open-accessibility-close-button,.open-accessibility-menu-button, .l-switch, .open-accessibility-language-selector, .open-accessibility-menu-footer").keyup(function(n){13!=n.keyCode&&32!=n.keyCode||(n.preventDefault(),t(this).click())});var Y;t(window).on("load resize",function(){Y=this.screen.height,b()}),t("#accDec").attr("href",f.accessibilityDeclaration),C.click(function(){f.isMenuOpened=!0,b()}),k.click(function(){f.isMenuOpened=!1,b()}),t(document).click(function(n){t(n.target).closest(".open-accessibility").length||f.isMenuOpened&&(f.isMenuOpened=!1,b())}),C.hide(),z.hide(),n.isMenuOpened?(f.isMenuOpened=!0,z.show(),C.hide()):f.isMenuOpened=!1,document.getElementById("togBtn").checked=f.toolbarSide,R.change(function(){f.toolbarSide=!f.toolbarSide,b()}),_.change(function(){f.localization=t(this).val();var n=f.localization;"he"==n?(f.localization=["he"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])):"en"==n?(f.localization=["en"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])):"ru"==n?(f.localization=["ru"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])):"ar"==n?(f.localization=["ar"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])):"es"==n?(f.localization=["es"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])):"fr"==n&&(f.localization=["fr"],q=c(f.localization,f.localizationMap),l(q[Object.keys(q)[0]])),f.isMenuOpened=!0,b()}),E.click(function(){f.fZoom=Math.min(f.maxFZoomLevel,f.fZoom+f.fZoomStep),b(),j.addClass("button-indicator"),j.removeClass("hidden-indicator"),setTimeout(d,2e3)}),M.click(function(){f.fZoom=Math.max(f.minFZoomLevel,f.fZoom-f.fZoomStep),b(),N.addClass("button-indicator"),N.removeClass("hidden-indicator"),setTimeout(m,2e3)}),I.click(function(){f.cursor=!f.cursor,b()}),A.click(function(){f.pZoom+=f.pZoomStep;var t=1/f.pZoom;f.mZoom=t,f.pZoom>f.maxPZoomLevel&&(f.pZoom=f.minPZoomLevel,f.mZoom=f.minPZoomLevel),b(),T.addClass("button-indicator"),T.removeClass("hidden-indicator"),setTimeout(u,2e3)}),F.hide(),e()||t(document).on("mousemove",function(t){f.cursor&&F.css({left:t.pageX/f.fZoom,top:t.pageY/f.fZoom})}),S.click(function(){f.contrast+=50,f.contrast>150&&(f.contrast=50),b()}),B.click(function(){f.invert=!f.invert,b()}),L.click(function(){f.grayscale+=100,f.grayscale>100&&(f.grayscale=0),b()}),O.click(function(){f.highlightedLinks=!f.highlightedLinks,b()}),Z.click(function(){f.isAnimStopped=!f.isAnimStopped,b()}),V.click(function(){f.imagesRemove=!f.imagesRemove,b()}),H.click(function(){f.focus=!f.focus,b()}),P.click(function(){f.fontReadable=!f.fontReadable,b()}),D.click(function(){f.headings=!f.headings,b()}),G.click(function(){var n=o();f=t.extend({},y),f.localization=n.localization,f.toolbarSide=n.toolbarSide,f.isMenuOpened=!0,b()}),b()}}(jQuery||$);