...
;var M=t("html"),L=(t("body"),t(".open-accessibility")),A=t(".open-accessibility-menu"),S=t(".open-accessibility-expand-button"),O=t(".open-accessibility-close-button"),Z=t(".open-accessibility-invert-button"),V=t(".open-accessibility-cursor-button"),P=t(".open-accessibility-font-zoom-in-button"),H=t(".open-accessibility-font-zoom-out-button"),D=t(".open-accessibility-page-zoom-button"),G=t(".open-accessibility-monochrome-button"),F=t(".open-accessibility-contrast-button"),N=t(".open-accessibility-links-button"),_=t(".open-accessibility-animation-button"),R=t(".open-accessibility-imgRemove-button"),T=t(".open-accessibility-focus-button"),j=t(".open-accessibility-fontReadable-button"),q=t(".open-accessibility-headings-button"),Y=t(".open-accessibility-revert-button"),$=t(".open-accessibility-cursor-workaround"),U=t("#lang-sel"),J=t("#togBtn"),K=t("#pZoom-indicator"),W=t("#fZoomIn-indicator"),Q=t("#fZoomOut-indicator");a(E.fontSelector,1),L.addClass(r(E.iconSize)),document.documentElement.style.setProperty("--main-color",E.mainColor),t("#open-accessibility-footer-logo").hover(function(){t(this).css("background-color","#e6e6e6"),t(".pw").css("fill",E.mainColor)},function(){t(this).css("background-color",E.mainColor),t(".pw").css("fill","#fff")});var X=c(E.localization,E.localizationMap);l(X[Object.keys(X)[0]]),M.addClass("open-accessibility-font-Zoom"),t(".open-accessibility-expand-button,.open-accessibility-close-button,.open-accessibility-menu-button, .l-switch, .open-accessibility-language-selector, .open-accessibility-menu-footer").keyup(function(e){13!=e.keyCode&&32!=e.keyCode||(e.preventDefault(),t(this).click())});var tt;t(window).on("load resize",function(){tt=this.screen.height,b()}),t("#accDec").attr("href",E.accessibilityDeclaration),S.click(function(){E.isMenuOpened=!0,b()}),O.click(function(){E.isMenuOpened=!1,b()}),t(document).click(function(e){t(e.target).closest(".open-accessibility").length||E.isMenuOpened&&(E.isMenuOpened=!1,b())}),S.hide(),A.hide(),e.isMenuOpened?(E.isMenuOpened=!0,A.show(),S.hide()):E.isMenuOpened=!1,document.getElementById("togBtn").checked=E.toolbarSide,J.change(function(){E.toolbarSide=!E.toolbarSide,b()}),U.change(function(){E.localization=t(this).val();var e=E.localization;"he"==e?(E.localization=["he"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"en"==e?(E.localization=["en"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"ru"==e?(E.localization=["ru"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"ar"==e?(E.localization=["ar"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"es"==e?(E.localization=["es"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"fr"==e?(E.localization=["fr"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])):"pt"==e&&(E.localization=["pt"],X=c(E.localization,E.localizationMap),l(X[Object.keys(X)[0]])),E.isMenuOpened=!0,b()}),P.click(function(){E.fZoom=Math.min(E.maxFZoomLevel,E.fZoom+E.fZoomStep),b(),W.addClass("button-indicator"),W.removeClass("hidden-indicator"),setTimeout(d,2e3)}),H.click(function(){E.fZoom=Math.max(E.minFZoomLevel,E.fZoom-E.fZoomStep),b(),Q.addClass("button-indicator"),Q.removeClass("hidden-indicator"),setTimeout(m,2e3)}),V.click(function(){E.cursor=!E.cursor,b()}),D.click(function(){E.pZoom+=E.pZoomStep;var t=1/E.pZoom;E.mZoom=t,E.pZoom>E.maxPZoomLevel&&(E.pZoom=E.minPZoomLevel,E.mZoom=E.minPZoomLevel),b(),K.addClass("button-indicator"),K.removeClass("hidden-indicator"),setTimeout(u,2e3)}),$.hide(),n()||t(document).on("mousemove",function(t){E.cursor&&$.css({left:t.pageX/E.fZoom,top:t.pageY/E.fZoom})}),F.click(function(){E.contrast+=50,E.contrast>150&&(E.contrast=50),b()}),Z.click(function(){E.invert=!E.invert,b()}),G.click(function(){E.grayscale+=100,E.grayscale>100&&(E.grayscale=0),b()}),N.click(function(){E.highlightedLinks=!E.highlightedLinks,b()}),_.click(function(){E.isAnimStopped=!E.isAnimStopped,b()}),R.click(function(){E.imagesRemove=!E.imagesRemove,b()}),T.click(function(){E.focus=!E.focus,b()}),j.click(function(){E.fontReadable=!E.fontReadable,b()}),q.click(function(){E.headings=!E.headings,b()}),Y.click(function(){var e=o();E=t.extend({},I),E.localization=e.localization,E.toolbarSide=e.toolbarSide,E.isMenuOpened=!0,b()}),b();var et=document.querySelector(".fill"),nt=document.querySelectorAll(".empty"),it=o(),ot=it.toolbarVertPos;t("#patd"+ot).append(et),et.addEventListener("dragstart",h),et.addEventListener("dragend",y);var st=!0,at=!1,lt=void 0;try{for(var ct,rt=nt[Symbol.iterator]();!(st=(ct=rt.next()).done);st=!0){var dt=ct.value;dt.addEventListener("dragover",f),dt.addEventListener("dragenter",w),dt.addEventListener("dragleave",x),dt.addEventListener("drop",z)}}catch(t){at=!0,lt=t}finally{try{!st&&rt.return&&rt.return()}finally{if(at)throw lt}}var pt,mt,ut,bt;t(window).on("load resize",function(){mt=this.innerHeight,console.log("windowHeight",mt),mt<768&&E.toolbarVertPos>=20?(ut=parseInt(mt/40)-1,bt="#patd"+ut,console.log("lowerResPos",ut),t(bt).append(et)):t(E.toolbarVertPos).append(et)})}}(jQuery||$);