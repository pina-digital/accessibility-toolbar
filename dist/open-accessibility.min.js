...
;var Z=t("html"),B=(t("body"),t(".open-accessibility")),V=t(".open-accessibility-menu"),P=t(".open-accessibility-expand-button"),H=t(".open-accessibility-close-button"),A=t(".open-accessibility-invert-button"),O=t(".open-accessibility-cursor-button"),I=t(".open-accessibility-font-zoom-in-button"),G=t(".open-accessibility-font-zoom-out-button"),F=t(".open-accessibility-page-zoom-button"),E=t(".open-accessibility-monochrome-button"),D=t(".open-accessibility-contrast-button"),j=t(".open-accessibility-links-button"),R=t(".open-accessibility-animation-button"),_=t(".open-accessibility-imgRemove-button"),T=t(".open-accessibility-focus-button"),N=t(".open-accessibility-fontReadable-button"),q=t(".open-accessibility-headings-button"),Y=t(".open-accessibility-revert-button"),J=t(".open-accessibility-cursor-workaround"),K=t("#lang-sel"),$=t("#togBtn"),Q=t("#pZoom-indicator"),U=t("#fZoomIn-indicator"),W=t("#fZoomOut-indicator");a(S.fontSelector,1),B.addClass(r(S.iconSize)),document.documentElement.style.setProperty("--main-color",S.mainColor),t("#open-accessibility-footer-logo").hover(function(){t(this).css("background-color","#e6e6e6"),t(".pw").css("fill",S.mainColor)},function(){t(this).css("background-color",S.mainColor),t(".pw").css("fill","#fff")});var X=l(S.localization,S.localizationMap);c(X[Object.keys(X)[0]]),Z.addClass("open-accessibility-font-Zoom"),t(".open-accessibility-expand-button,.open-accessibility-close-button,.open-accessibility-menu-button, .l-switch, .open-accessibility-language-selector, .open-accessibility-menu-footer").keyup(function(n){13!=n.keyCode&&32!=n.keyCode||(n.preventDefault(),t(this).click())});var tt;t(window).on("load resize",function(){tt=this.screen.height,v()}),t("#accDec").attr("href",S.accessibilityDeclaration),P.click(function(){S.isMenuOpened=!0,v()}),H.click(function(){S.isMenuOpened=!1,v()}),t(document).click(function(n){t(n.target).closest(".open-accessibility").length||S.isMenuOpened&&(S.isMenuOpened=!1,v())}),P.hide(),V.hide(),n.isMenuOpened?(S.isMenuOpened=!0,V.show(),P.hide()):S.isMenuOpened=!1,t("#togBtn").prop("checked",S.toolbarSide),$.change(function(){S.toolbarSide=!S.toolbarSide,v()}),K.change(function(){S.localization=t(this).val();var n=S.localization;"he"==n?(S.localization=["he"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"en"==n?(S.localization=["en"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"ru"==n?(S.localization=["ru"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"ar"==n?(S.localization=["ar"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"es"==n?(S.localization=["es"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"fr"==n?(S.localization=["fr"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])):"pt"==n&&(S.localization=["pt"],X=l(S.localization,S.localizationMap),c(X[Object.keys(X)[0]])),S.isMenuOpened=!0,v()}),I.click(function(){S.fZoom=Math.min(S.maxFZoomLevel,S.fZoom+S.fZoomStep),v(),U.addClass("button-indicator"),U.removeClass("hidden-indicator"),setTimeout(d,2e3)}),G.click(function(){S.fZoom=Math.max(S.minFZoomLevel,S.fZoom-S.fZoomStep),v(),W.addClass("button-indicator"),W.removeClass("hidden-indicator"),setTimeout(m,2e3)}),O.click(function(){S.cursor=!S.cursor,v()}),F.click(function(){S.pZoom+=S.pZoomStep;var t=1/S.pZoom;S.mZoom=t,S.pZoom>S.maxPZoomLevel&&(S.pZoom=S.minPZoomLevel,S.mZoom=S.minPZoomLevel),v(),Q.addClass("button-indicator"),Q.removeClass("hidden-indicator"),setTimeout(b,2e3)}),J.hide(),e()||t(document).on("mousemove",function(t){S.cursor&&J.css({left:t.pageX/S.fZoom,top:t.pageY/S.fZoom})}),D.click(function(){S.contrast+=50,S.contrast>150&&(S.contrast=50),v()}),A.click(function(){S.invert=!S.invert,v()}),E.click(function(){S.grayscale+=100,S.grayscale>100&&(S.grayscale=0),v()}),j.click(function(){S.highlightedLinks=!S.highlightedLinks,v()}),R.click(function(){S.isAnimStopped=!S.isAnimStopped,v()}),_.click(function(){S.imagesRemove=!S.imagesRemove,v()}),T.click(function(){S.focus=!S.focus,v()}),N.click(function(){S.fontReadable=!S.fontReadable,v()}),q.click(function(){S.headings=!S.headings,v()}),Y.click(function(){var n=o();S=t.extend({},L),S.localization=n.localization,S.toolbarSide=n.toolbarSide,S.isMenuOpened=!0,v()}),v();var nt=document.querySelector(".fill"),et=document.querySelectorAll(".empty"),it=o(),ot=it.toolbarVertPos;t("#patd"+ot).append(nt),nt.addEventListener("dragstart",h),nt.addEventListener("dragend",f);var st=!0,at=!1,ct=void 0;try{for(var lt,rt=et[Symbol.iterator]();!(st=(lt=rt.next()).done);st=!0){var dt=lt.value;dt.addEventListener("dragover",y),dt.addEventListener("dragenter",x),dt.addEventListener("dragleave",w),dt.addEventListener("drop",z)}}catch(t){at=!0,ct=t}finally{try{!st&&rt.return&&rt.return()}finally{if(at)throw ct}}var pt,mt,bt,vt;t(window).on("load resize",function(){mt=this.innerHeight,mt<768&&S.toolbarVertPos>=20?(bt=parseInt(mt/40)-1,vt="#patd"+bt,t(vt).append(nt)):t(S.toolbarVertPos).append(nt)})}}(jQuery||$);