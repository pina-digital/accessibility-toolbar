...
;var A=t("html"),Z=(t("body"),t(".open-accessibility")),S=t(".open-accessibility-menu"),I=t(".open-accessibility-expand-button"),E=t(".open-accessibility-close-button"),V=t(".open-accessibility-invert-button"),H=t(".open-accessibility-cursor-button"),P=t(".open-accessibility-font-zoom-in-button"),O=t(".open-accessibility-font-zoom-out-button"),F=t(".open-accessibility-page-zoom-button"),G=t(".open-accessibility-monochrome-button"),D=t(".open-accessibility-contrast-button"),j=t(".open-accessibility-links-button"),R=t(".open-accessibility-animation-button"),_=t(".open-accessibility-imgRemove-button"),T=t(".open-accessibility-focus-button"),N=t(".open-accessibility-fontReadable-button"),q=t(".open-accessibility-headings-button"),Y=t(".open-accessibility-revert-button"),J=t(".open-accessibility-cursor-workaround"),K=t("#lang-sel"),$=t("#togBtn"),Q=t("#pZoom-indicator"),U=t("#fZoomIn-indicator"),W=t("#fZoomOut-indicator");a(L.fontSelector,1),Z.addClass(r(L.iconSize)),document.documentElement.style.setProperty("--main-color",L.mainColor),t("#open-accessibility-footer-logo").hover(function(){t(this).css("background-color","#e6e6e6"),t(".pw").css("fill",L.mainColor)},function(){t(this).css("background-color",L.mainColor),t(".pw").css("fill","#fff")});var X=l(L.localization,L.localizationMap);c(X[Object.keys(X)[0]]),A.addClass("open-accessibility-font-Zoom"),t(".open-accessibility-expand-button,.open-accessibility-close-button,.open-accessibility-menu-button, .l-switch, .open-accessibility-language-selector, .open-accessibility-menu-footer").keyup(function(n){13!=n.keyCode&&32!=n.keyCode||(n.preventDefault(),t(this).click())});var tt;t(window).on("load resize",function(){tt=this.screen.height,u()}),t("#accDec").attr("href",L.accessibilityDeclaration),I.click(function(){L.isMenuOpened=!0,u()}),E.click(function(){L.isMenuOpened=!1,u()}),t(document).click(function(n){t(n.target).closest(".open-accessibility").length||L.isMenuOpened&&(L.isMenuOpened=!1,u())}),I.hide(),S.hide(),n.isMenuOpened?(L.isMenuOpened=!0,S.show(),I.hide()):L.isMenuOpened=!1,t("#togBtn").prop("checked",L.toolbarSide),$.change(function(){L.toolbarSide=!L.toolbarSide,u()}),K.change(function(){L.localization=t(this).val();var n=L.localization;"he"==n?(L.localization=["he"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"en"==n?(L.localization=["en"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"ru"==n?(L.localization=["ru"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"ar"==n?(L.localization=["ar"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"es"==n?(L.localization=["es"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"fr"==n?(L.localization=["fr"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])):"pt"==n&&(L.localization=["pt"],X=l(L.localization,L.localizationMap),c(X[Object.keys(X)[0]])),L.isMenuOpened=!0,u()}),P.click(function(){L.fZoom=Math.min(L.maxFZoomLevel,L.fZoom+L.fZoomStep),u(),U.addClass("button-indicator"),U.removeClass("hidden-indicator"),setTimeout(d,2e3)}),O.click(function(){L.fZoom=Math.max(L.minFZoomLevel,L.fZoom-L.fZoomStep),u(),W.addClass("button-indicator"),W.removeClass("hidden-indicator"),setTimeout(m,2e3)}),H.click(function(){L.cursor=!L.cursor,u()}),F.click(function(){L.pZoom+=L.pZoomStep;var t=1/L.pZoom;L.mZoom=t,L.pZoom>L.maxPZoomLevel&&(L.pZoom=L.minPZoomLevel,L.mZoom=L.minPZoomLevel),u(),Q.addClass("button-indicator"),Q.removeClass("hidden-indicator"),setTimeout(b,2e3)}),J.hide(),e()||t(document).on("mousemove",function(t){L.cursor&&J.css({left:t.pageX/L.fZoom,top:t.pageY/L.fZoom})}),D.click(function(){L.contrast+=50,L.contrast>150&&(L.contrast=50),u()}),V.click(function(){L.invert=!L.invert,u()}),G.click(function(){L.grayscale+=100,L.grayscale>100&&(L.grayscale=0),u()}),j.click(function(){L.highlightedLinks=!L.highlightedLinks,u()}),R.click(function(){L.isAnimStopped=!L.isAnimStopped,u()}),_.click(function(){L.imagesRemove=!L.imagesRemove,u()}),T.click(function(){L.focus=!L.focus,u()}),N.click(function(){L.fontReadable=!L.fontReadable,u()}),q.click(function(){L.headings=!L.headings,u()}),Y.click(function(){var n=o();L=t.extend({},B),L.localization=n.localization,L.toolbarSide=n.toolbarSide,L.isMenuOpened=!0,u()}),u();var nt=document.querySelector(".fill"),et=document.querySelectorAll(".empty"),it=o(),ot=it.toolbarVertPos;t("#patd"+ot).append(nt),nt.addEventListener("dragstart",h),nt.addEventListener("dragend",f);var st=!0,at=!1,ct=void 0;try{for(var lt,rt=et[Symbol.iterator]();!(st=(lt=rt.next()).done);st=!0){var dt=lt.value;dt.addEventListener("dragover",y),dt.addEventListener("dragenter",x),dt.addEventListener("dragleave",w),dt.addEventListener("drop",z)}}catch(t){at=!0,ct=t}finally{try{!st&&rt.return&&rt.return()}finally{if(at)throw ct}}var pt,mt,bt,ut;t(window).on("load resize",function(){mt=this.innerHeight,mt<768&&L.toolbarVertPos>=20?(bt=parseInt(mt/40)-1,ut="#patd"+bt,t(ut).append(nt)):t(L.toolbarVertPos).append(nt)})}}(jQuery||$);